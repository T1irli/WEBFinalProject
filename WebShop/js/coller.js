...
let collerArr = [new Coller('Test', 999, 'img/pic1.jpg')]

for(let item of collerArr){
...
'<div class="shop-item">' + 
    '<img src="img/pic1.jpg" alt="cooler">' +
    '<div class="shop-item-info">' + 
        '<h3>' + coller.name + '</h3>' + 
       '<p class="discount">' + coller.getOldPrice() + '$</p>'+
    '</div>'+
    '<div class="shop-footer">'+
        '<p class="price">' + coller.price + '$</p>' + 
        '<div class="cart-btn" onclick="openModalPanel()">' +
